  ...
  void setAtributs() {
    ...
    if (widget.isUpdate) {
      ...
      if (appStore.userViewModel.userType == 'Master') {
        ...
        if (widget.userViewModel.userType == 'Atendente' ||
            widget.userViewModel.userType == 'Atendente-Dev') {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  ? <Widget>[
                                      Radio(
                                        ...
                                        onChanged: (val) {
                                          ...
                                          print(
                                              'radiobuttom ${signupUserStore.userType}');
                                        },
                                      ),
                                      Text(signupUserStore.userTypes[0]),
                                      Radio(
                                        groupValue: signupUserStore.nivel,
                                        value: false,
                                        onChanged: (val) {
                                      ...
                                      Text(signupUserStore.userTypes[1]),
                                    ]
                                  : <Widget>[
                                      Radio(
                        ...
                        appStore.userViewModel.userType != "Atendente" ||
